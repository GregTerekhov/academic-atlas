...
export default function PrimaryButton({
  ...
  const disabledStyle = isDisabled
    ...
    : 'bg-accent-gradient hocus:bg-none hocus:bg-whiteBase/10 hocus:outline-none hocus:ring-[2px] hocus:ring-accentSecondary-darker text-whiteBase transition-colors duration-500';
