  ...
  return (
    <ScrollArea.Root type='auto'>
      ...
      <ScrollArea.Scrollbar
        ...
        className='!right-4 !top-4 touch-none select-none bg-darkBase/10 p-0.5 transition-colors data-[orientation=vertical]:h-full data-[orientation=vertical]:w-4 dark:bg-darkBase/75'
      >
