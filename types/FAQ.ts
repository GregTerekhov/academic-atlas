...
export enum QuestionAnswer {
  ...
  Answer10 = 'По завершенню виконання наш менеджер зв`яжеться з Вами. Після оплати решти суми ми відправимо всі матеріали замовлення на вашу електрону пошту або в Telegram.',
}
