...
export enum MetadataDescription {
  HOME = 'Професійні послуги з написання магістерських робіт, курсових робіт, лабораторних робіт і наукових статей. Високоякісні, оригінальні академічні роботи для ваших потреб.',
