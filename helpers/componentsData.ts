...
export const getOfferArticles = (): ILegalInfoArticle[] => {
  return [
    ...
    },
    {
      ...
      paragraph: {
        one: 'Умови конфіденційності визначені Політикою конфіденційності, що є невід’ємною частиною Договору та розміщені на сторінці http://AcademicAtlas.com.ua/policy.', //FIXME: add real site address
      },
    },
    {
      id: 10,
