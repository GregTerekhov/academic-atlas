...
export const getCarouselFeedbackStyles = (isActive: boolean, className: string) => {
  return {
    slideClass: isActive
      ? 'swiper-slide-active max-sm:!w-[calc(100vw - 48px)] sm:!w-[301px] border-2 border-accentPrimary bg-whiteBase/10 md:max-lg:dark:bg-background-dark-gradient md:max-lg:bg-whiteBase md:max-lg:bg-background-light-gradient p-4 max-md:!mr-0 md:!w-[436px] md:p-8 lg:!w-[496px] lg:p-12'
