export const getScrollBarAreaStyles = () => {
  return '!right-4 !top-4 touch-none select-none bg-darkBase/10 p-0.5 transition-colors data-[orientation=vertical]:h-full data-[orientation=vertical]:!max-h-scroll data-[orientation=vertical]:w-4 dark:bg-darkBase/75';
};

export const getScrollThumbStyles = () => {
  return "relative before:absolute before:h-full before:w-3 before:rounded-lg before:bg-disabled-foreground before:content-['']";
};
