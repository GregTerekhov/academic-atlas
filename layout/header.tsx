...
export default function Header() {
  return (
    <header className='fixed left-0 top-0 z-10 max-h-20 w-full border-b-[0.5px] border-accentSecondary bg-whiteBase py-2 dark:border-whiteBase dark:bg-background-gradient md:max-h-24 md:py-4 lg:max-h-28'>
      <Container>
