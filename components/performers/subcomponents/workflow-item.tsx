  ...
  return (
    ...
    >
      <div className='w-max rounded-full bg-accentPrimary dark:bg-accentSecondary md:mx-auto'>
        <span className='flex size-10 items-center justify-center text-medium font-bold text-whiteBase dark:text-darkBase-light md:size-[46px] md:text-big lg:size-12 lg:text-xl'>
          {count}
        </span>
      </div>
