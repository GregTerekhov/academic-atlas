...
export default function RequirementsItem({ title, desc }: IRequirementsItemProps) {
  return (
    <li className='blockItem bg-whiteBase/10 p-4 lg:basis-1/3 lg:p-6'>
      <div className='mb-2 mr-auto flex items-center gap-x-4 lg:gap-x-2'>
        <SvgIconUI
          ...
          className='fill-accentSecondary md:size-8 lg:size-10'
        />
        <h3 className='text-medium font-bold text-accentSecondary md:text-big lg:text-xl'>
          {title}
        </h3>
      </div>
