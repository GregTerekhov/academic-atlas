...
export { default as SkeletonDesktop } from './skeleton/large';
export { default as SkeletonMobile } from './skeleton/small';
export { default as SkeletonTablet } from './skeleton/medium';
