...
export default function ServiceItem({ imageSrc, imageAlt, serviceTitle }: Readonly<IServiceItem>) {
  return (
    <li className='relative h-[120px] w-[152px] overflow-hidden rounded-xl border border-accentSecondary align-bottom hocus:border-transparent hocus:bg-whiteBase/10 hocus:outline-none hocus:ring-[2px] hocus:ring-accentPrimary md:w-[160px] lg:h-[307px] lg:w-[293px]'>
      <a
      ...
      >
        <Image
          ...
          width={152}
          height={80}
          className='absolute top-0 md:w-40 lg:h-[149px] lg:w-[293px]'
        />
