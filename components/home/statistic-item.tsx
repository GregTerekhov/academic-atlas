...
export default function StatisticItem({
  ...
  return (
    <p
      className={`flex flex-col items-center justify-center ${hideOnSmallScreen ? 'hidden md:flex' : ''} ${hideOnLargeScreen ? 'hidden max-lg:flex' : ''} ${showOnLargeScreen ? 'hidden lg:flex' : ''} md:text-base lg:text-big`}
    >
