...
export default function LegalInfo() {
  ...
  return (
    ...
    >
      <article className="prose-sm md:prose-base lg:prose-xl prose-p:text-pretty prose-a:text-accentSecondary prose-a:hover:underline  prose-ol:text-pretty  prose-ol:[counter-reset:section]  prose-li:[counter-increment:section] prose-li:marker:[content:counters(section,'.')]">
