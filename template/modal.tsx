  ...
  return (
    isOpen(id) && (
      <div className='fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center overflow-auto bg-disabled-background/50 transition-colors dark:bg-darkBase/75'>
        <div
          ref={modalRef}
          className='relative rounded-[20px] border-2 border-solid border-accentSecondary bg-whiteBase bg-background-light-gradient p-14 dark:bg-background-dark-gradient dark:text-whiteBase lg:w-[752px]'
        >
          <button
          ...
          >
            <SvgIconUI
              ...
              className='fill-darkBase group-hover:fill-accentSecondary group-focus:fill-accentSecondary dark:fill-whiteBase'
            />
          </button>
          {children}
        </div>
